...
import { createKeplrChainInfos, SimplifiedChainInfo } from '@utils/chains';
	...
	[
		...
		},
		{
			...
			currencies: [
				...
				{
					type: 'cw20',
					contractAddress: 'ki1dt3lk455ed360pna38fkhqn0p8y44qndsr77qu73ghyaz2zv4whq83mwdy',
					coinDenom: 'LVN',
					coinMinimalDenom: 'cw20:ki1dt3lk455ed360pna38fkhqn0p8y44qndsr77qu73ghyaz2zv4whq83mwdy:LVN',
					coinDecimals: 6,
					coinGeckoId: 'lvn',
		...
		},
		{
			...
			features: ['stargate', 'ibc-transfer', 'no-legacy-stdTx', 'ibc-go'],
			explorerUrlToTx: 'https://explorer.unification.chainmasters.ninja/unification/tx/{txHash}',
		},
		{
...
export const ChainDropdownOptions = [CHAINS[CHAIN_ID]].map((chain: any) => {
	...
	return {
		...
		img: 'https://app.osmosis.zone' + stakeCurrency?.coinImageUrl,
	};
});
